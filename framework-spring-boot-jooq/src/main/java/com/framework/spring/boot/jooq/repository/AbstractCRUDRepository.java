package com.framework.spring.boot.jooq.repository;

import com.framework.common.tool.DateTools;
import com.framework.common.tool.NumberTools;
...
public abstract class AbstractCRUDRepository<R extends UpdatableRecord, ID, P extends BaseDomainPo> {
