...
import com.geai.asset.domain.constant.ApiConstant;
import com.geai.asset.domain.constant.ApiMessageCode;
import com.geai.asset.domain.model.enums.AccountUserStatus;
import com.geai.asset.domain.model.enums.AuthTokenLoginRole;
import com.geai.asset.domain.pojo.dto.input.ApiLoginDto;
import com.geai.asset.domain.pojo.dto.output.ApiLoginOutDto;
import com.geai.asset.domain.pojo.po.AccountUserPo;
import com.geai.asset.domain.pojo.po.AuthClientPo;
import com.geai.asset.domain.pojo.po.AuthTokenPo;
import com.geai.asset.domain.service.AccountUserService;
import com.geai.asset.domain.service.AuthClientService;
import com.geai.asset.domain.service.AuthTokenService;
import com.geai.common.pojo.ResultDo;
import com.geai.common.tool.*;
...
public class ApiSecurityAuthComponent {
     ...
     * @return
     */
    public ResultDo<AuthTokenPo> getTokenInfo(String token, String ip) {
        return authTokenService.getTokenInfo(token, tokenSecret, ip);
    }
